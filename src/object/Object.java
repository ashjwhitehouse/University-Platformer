...
public abstract class Object {
	...
	public boolean insersects(Object other) {
	...
	public boolean setLeft(boolean b) {
		left = b;
	}
	
	public boolean setDown(boolean b) {
		down = b;
	}
	
	public boolean setRight(boolean b) {
		right = b;
	}
	
	public boolean setJumping(boolean b) {
		jumping = b;
	}
