...
public abstract class Object {
	...
	public void draw(Graphics2D graphics) {
		if(flip) {
			graphics.drawImage(animation.getImage(), (int)(x + mapx - width / 2), (int)(y + mapy - height / 2), null);
		}
		else {
			graphics.drawImage(animation.getImage(), (int)(x + mapx - width / 2 + width), (int)(y + mapy - height / 2), -width, height, null);
		}
	}
